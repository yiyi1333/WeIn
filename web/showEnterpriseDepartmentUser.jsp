            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="table_data_tables.html">数据表格</a></li>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    %>
                                    <tr>
                                        <td><%=enterpriseUser.getConsumerId()%></td>
                                        <td><%=enterpriseUser.getName()%></td>
                                        <td><%=enterpriseUser.getEnterpriseDepartmentId()%></td>
                                        <td><%=enterpriseUser.getEnterpriseDepartmentName()%></td>
                                    </tr>
                                    <%}%>
                                    </tbody>
                                    <tfoot>
