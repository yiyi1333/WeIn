                        ...
                        <div class="ibox-content">
                            <form action="addenterpriseDepartment.action">
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">部门名称</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="enterpriseDepartment.enterpriseDepartmentName"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">所属企业</label>
                                    <div class="col-sm-10"><select class="form-control m-b"  name="enterpriseDepartment.enterpriseId">
                                        <option value="1">WeIn</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">所属部门</label>
                                    <div class="col-sm-10"><select class="form-control m-b"  name="enterpriseDepartment.enterpriseDepartmentpre">
