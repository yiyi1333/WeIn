                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="orderId" name="orders.orderId"
                                       value="<%=orders.getDeliveredName()%>" disabled class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-form-label" for="orderId">收货人电话号码：</label>
                                <input type="text" name="orders.orderId" value="<%=orders.getDeliveredPhone()%>"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId"
                                       value="<%=orders.getDeliverProvince()%> <%=orders.getDeliverCity()%><%=orders.getDeliverArea()%><%=orders.getDeliveredDetailedAddress()%>"
                                       disabled class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId" value="<%=orders.getWarehouseName()%>" disabled
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId" value="<%=orders.getWarehousePhone()%>"
                                       disabled class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId"
                                       value="<%=orders.getWarehouseProvince()%> <%=orders.getWarehouseCity()%><%=orders.getWarehouseArea()%><%=orders.getWarehouseDetailedAddress()%>"
                                       disabled class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId"
                                       value="<%=safeGuardingRights.getSafeGuardingRightsNum()%>份" disabled
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="orders.orderId"
                                       value="<%=safeGuardingRights.getSafeGuardingRightsType()%>" disabled
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select id="safeGuardingRightsProgress"
                                        name="safeGuardingRights.safeGuardingRightsProgress" class="form-control">
                                    <option value="退换货">退换货</option>
                                    <option value="仅退款">仅退款</option>
                                    <option value="退货退款">退货退款</option>
                                    <option value="已完成">维权失败</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <div id="vertical-timeline" class="vertical-container dark-timeline center-orientation">
                                ...
                                <div class="vertical-timeline-block">
                                    ...
                                    <div class="vertical-timeline-content">
                                        <h2>顾客：<%=orders.getConsumerId()%>
                                        </h2>
                                        <p>购买商品：<%=goods.getGoodsName()%>
                                        </p>
                                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                                                src="<%=goods.getGoodsImage()%>" alt="图片无法显示" style="height: 80px"></p>
                                    </div>
                                </div>
                                <div class="vertical-timeline-block">
                                    <div class="vertical-timeline-icon blue-bg">
                                    ...
                                    <div class="vertical-timeline-content">
                                        ...
                                        <p>维权理由：<%=safeGuardingRights.getSafeGuardingRightsDetails()%>
                                        </p>
                                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                                                src="<%=safeGuardingRights.getSafeGuardingRightsImage()%>"
                                                alt="用户没有上传图片" style="height: 80px"></p>
                                    </div>
                                </div>
                                ...
                                <%} else if (safeGuardingRightsProgress.getSafeGuardingRightsProgressStatus().equals("平台处理中")) {%>
                                <div class="vertical-timeline-block">
                                    <div class="vertical-timeline-icon navy-bg">
                                        <i class="fa fa-briefcase"></i>
                                    </div>
