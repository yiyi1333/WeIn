        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="displayAddress.action"><i class="fa fa-plus-square"></i>添加商品</a></li>
                    <li><a href="displayShopGoods.action"><i class="fa fa-bars"></i>查看商品信息</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li><a href="getLogisticsSingle.action"><i class="fa fa-check-square-o"></i>填写物流信息</a></li>
                </ul>
            </li>
            <li>
                <a href="getAllFundFlow.action"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">流水统计</span></a>
            </li>
            <li>
